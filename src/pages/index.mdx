...
Open source software is generally by a developer or group of
developers that
software to meet their own needs.

Contributing to open-source
The OSS community is made up of people who contribute to the public good by
writing code.

Open-source software (OSS) is software with source code anyone can inspect,
modify, duplicate, or enhance.
