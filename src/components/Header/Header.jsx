...
const Header = React.memo(
  ({ mobile, visible, toggleVisibility }) => {
    ...
    return(
      ...
      {/*      <li role="menuitem" tabIndex={(mobile && !visible) ? -1 : 1}>*/}
      {/*        <Link href='/blog'>*/}
      {/*          <Text variant="label">*/}
      {/*            Writing <span>📓</span>*/}
      {/*          </Text>*/}
      ...
      {/*      <li role="menuitem" tabIndex={mobile && !visible ? -1: 2}>*/}
      {/*        <Link href='/projects'>*/}
      {/*          <Text variant="label">*/}
      {/*            Work <span>🚀</span>*/}
      {/*          </Text>*/}
      ...
      {/*      <li role="menuitem" tabIndex={mobile && !visible ? -1 : 3}>*/}
      {/*        <Link href='/resources'>*/}
      {/*          <Text variant="label">*/}
      {/*            Resources <span>💽</span>*/}
      {/*          </Text>*/}
      ...
      {/*      <li role="menuitem" tabIndex={mobile && !visible ? -1 : 4}>*/}
      {/*        <Link href='/about'>*/}
      {/*          <Text variant="label">*/}
      {/*            About <span>👨‍💻</span>*/}
      {/*          </Text>*/}
      ...
      {/*  <Flex mr={4} justifyContent="center" flexDirection="column" className="toggle">*/}
      {/*    <ThemeToggle />*/}
      {/*  </Flex>*/}

      {/*  {mobile && (*/}
      {/*    <Box id="MobileButtonToggle"*/}
      {/*         type="button"*/}
      ...
      {/*</StyledHeader>*/}
        ...
        <Flex as="nav">
          <HeaderLink href='/' name='OSS-Advocacy' />
        </Flex>
      </>
    )
  }
